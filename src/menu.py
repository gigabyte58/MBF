...
def menu_apikey():
  ...
  print("\x1b[0;34m ----------------------------------------------------------------------------------");time.sleep (0.03)
  print("\x1b[0;34m YOU-ARE-NOT-PREMIUM-USER⭕   \033[1;97m")
  print("\x1b[0;34m YOUR LICENSE KEY 🗝️ : "+id)
  print("\x1b[0;34m COPY YOUR LICENSE AND PRESS ENTER TO SEND TO THE ADMIN")
  print("\x1b[0;34m CHECKING SERVER.........                                                ");time.sleep (0.03)
  print("\x1b[0;34m -----------------------------------------------------------------------------------");time.sleep (0.03)
  try:
    httpCaht = requests.get("https://pastebin.com/raw/5gAmA8AJ").text
    if id in httpCaht:
      print("\033[1;92mYOUR LICENSE ACTIVATED✅✅...!")
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:
      print("\x1b[1;91mID ACTIVATE (FB) INBOX  ADMIN")
...
def logo():
	clear_screen()
	prints(Panel(f"""{color_rich}            ___      ___  _______    _______  
           |"  \    /"  ||   _  "\  /"     "|  {H2}███████████████████████{reset}
            \   \  //   |(. |_)  :)(: ______)  {H2}██████████{M2}████{H2}█████████{reset}
            /\\  \/.    ||:     \/  \/    |     {H2}██████████{M2}████{H2}█████████{reset}
           |: \.        |(|  _  \\  // ___)     {H2}███████████████████████{reset}
           |.  \    /:  ||: |_)  :)(:  (       Multiple Bruteforce Tools 
           |___|\__/|___|(_______/  \__/      Made By {M2}AS{H2}IAN {P2}Coder""",title=f"{P2}{waktu()}",style=f"{color_table}"))
